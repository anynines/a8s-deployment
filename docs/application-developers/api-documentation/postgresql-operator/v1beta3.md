...
| `exposePrimary` _[ExposeOption](#exposeoption)_ | ExposePrimary allows you to expose the primary node of the PostgreSQL instance to connections from outside the cluster. Disabled by default. |
